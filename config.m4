...
if test "$PHP_FASTTEXT" != "no"; then
  ...
  SEARCH_FOR="/include/fasttext.h"  # you most likely want to change this
  ...
  if test -z "$FASTTEXT_DIR"; then
    ...
    AC_MSG_ERROR([Please reinstall the fasttext distribution])
  fi
  ...
  LIBNAME="fasttext"            # you may want to change this
  LIBSYMBOL="FastTextTest"      # you most likely want to change this 
